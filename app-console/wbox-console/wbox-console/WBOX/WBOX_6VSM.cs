...
namespace wbox_console.WBOX
{
    public class WBOX_6VSM
    {
        ...
        public WBOX_6VSM(string filePath)
        {
            ...
            mDefaultSectionChunkSize = ByteFunctions.ReadUnsignedInt(fileBytes, ref bytePointerPosition);
            Console.WriteLine("WBOX Default Section Chunk Size: '{0}'", mDefaultSectionChunkSize);

            //-------------------------Debug Section Chunk Size-------------------------- [4 bytes]
            mDebugSectionChunkSize = ByteFunctions.ReadUnsignedInt(fileBytes, ref bytePointerPosition);
            Console.WriteLine("WBOX Debug Section Chunk Size = {0}", mDebugSectionChunkSize);

            //--------------------------Async Section Chunk Size-------------------------- [4 bytes]
            mAsyncSectionChunkSize = ByteFunctions.ReadUnsignedInt(fileBytes, ref bytePointerPosition);
            Console.WriteLine("WBOX Async Section Chunk Size = {0}", mAsyncSectionChunkSize);

            //--------------------------CALCULATING HEADER LENGTH--------------------------
            uint calculated_HeaderLength = (uint)fileBytes.Length - mDefaultSectionChunkSize;
            ConsoleFunctions.SetConsoleColor(ConsoleColor.Black, ConsoleColor.Cyan);
